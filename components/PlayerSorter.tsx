...
function insertCandidate(state: SortState, insertIndex: number): SortState {
...
function recordChoice(state: SortState, winnerId: string, opponentId: string): SortState {
...
export function PlayerSorter() {
  ...
  const rankedCount = rankedPlayers.length;
  const progress = selectedPlayers.length ? Math.round((rankedCount / selectedPlayers.length) * 100) : 0;
    ...
    <div className="sorter-shell">
      ...
      <section className="sorter-board">
        <div className="sorter-status">
          <div>
            <strong>
              {rankedCount} / {selectedPlayers.length}
            </strong>
            <span className="muted">players ranked</span>
          </div>
          <div>
        ...
        {complete ? (
          <div className="sorter-complete">
            ...
            <p className="muted">Every player in this pool has been placed into your ranking.</p>
          </div>
